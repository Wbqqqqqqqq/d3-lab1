...
// Microsoft (MSFT)
// 
// Refer to demo.js Section 5 for guidance
// ============================================================================
...
// Create a time scale using d3.scaleUtc()
...
// Create a line generator using d3.line()
const line = d3.line()
    .x(d => x(d.Date))
    .y(d => y(d.Close))
    .curve(d3.curveMonotoneX); 

// Loop through each stock and draw a line
stocks.forEach(stock => {
    svg.append('path')
        .datum(stock.values)
        .attr('fill', 'none')
...
// Y Axis Label
// Add a label to the left of the y-axis (rotated)
svg.append('text')
...
// For each stock, create a legend entry
stocks.forEach((stock, i) => {
    const legendRow = legend.append('g')
        .attr('transform', `translate(0, ${i * 20})`);

    // Add a colored line showing the stock's color
    ...
    // Add text label with the stock name
